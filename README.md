...
Feel free to [file issues](https://github.com/ajlopez/AjGenesisNode-Angular) and submit
[pull requests](https://github.com/ajlopez/AjGenesisNode-Angular/pulls) — contributions are
welcome.
